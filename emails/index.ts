  ...
  return `
    <div style="font-family:sans-serif;max-width:480px;margin:0 auto;">
      ...
      <table style="width:100%;border-collapse:collapse;margin:16px 0;">
        <tr><td style="padding:8px 12px;background:#f9f9f9;font-weight:600;">Nombre</td><td style="padding:8px 12px;">${name}</td></tr>
        <tr><td style="padding:8px 12px;background:#f9f9f9;font-weight:600;">Email</td><td style="padding:8px 12px;">${email}</td></tr>
...
export function adminNewBookingHtml(userName: string, userEmail: string, therapyName: string, dateStr: string): string {
  return `
    <div style="font-family:sans-serif;max-width:480px;margin:0 auto;">
      ...
      <table style="width:100%;border-collapse:collapse;margin:16px 0;">
        <tr><td style="padding:8px 12px;background:#f9f9f9;font-weight:600;">Cliente</td><td style="padding:8px 12px;">${userName}</td></tr>
        <tr><td style="padding:8px 12px;background:#f9f9f9;font-weight:600;">Email</td><td style="padding:8px 12px;">${userEmail}</td></tr>
        <tr><td style="padding:8px 12px;background:#f9f9f9;font-weight:600;">Terapia</td><td style="padding:8px 12px;">${therapyName}</td></tr>
  ...
  return `
    <div style="font-family:sans-serif;max-width:520px;margin:0 auto;">
      ...
      <div style="padding:32px;background:#fff;border:1px solid #eee;border-top:0;border-radius:0 0 12px 12px;">
        ...
        <p style="color:#555;margin:0 0 4px 0;font-size:14px;">Hola <strong>${userName}</strong>,</p>
        <p style="color:#555;margin:0 0 16px 0;font-size:14px;">Tu sesión de <strong>${therapyName}</strong> ha sido completada.</p>
        <div style="background:#f9f9f9;border-left:4px solid #7b2d8e;padding:16px;margin:16px 0;border-radius:4px;">
          ...
          <p style="margin:0;color:#444;font-size:14px;line-height:1.6;white-space:pre-wrap;">${notes}</p>
        </div>
